...
python -u party.py --number_of_parties $7 --party_id $9 --base_port $1 --number_of_samples $2 --number_of_snps $3 --number_of_covariates $4 --number_of_blocks $5 --number_of_folds $6 --number_of_blocks_per_run $8 >> ${party_dir}/output.txt 2>> ${party_dir}/error.txt
